...
export class SoftTokenAlert {
  readonly diaRef = inject<DialogRef<SoftTokenAlertProps>>(DialogRef);
...
export type SoftTokenAlertProps = { loading: Signal<boolean>; save: (token: string) => void };
