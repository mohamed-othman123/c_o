...
export type CertificateDetailsWidgetStatus = 'empty' | 'loading' | 'error' | 'default';

@Component({
  selector: 'app-certificate-details-widget',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [Icon, Card, Button, CommonModule, TranslocoDirective, RouterModule],
  template: `
    <scb-card
      class="py-xl col-span-8 row-span-8 flex h-full flex-col rounded-4xl !px-0"
...
export class CertificateDetailsWidget {
  readonly status = input<CertificateDetailsWidgetStatus>('loading');
