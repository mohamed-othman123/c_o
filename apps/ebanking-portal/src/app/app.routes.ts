    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: ':detailId',
            loadComponent: () => import('./home/pending-approvals/details/transfer-details.ng'),
            data: {
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: ':detailId',
            loadComponent: () => import('./home/pending-approvals/details/product-details.ng'),
            data: {
              breadcrumb: 'pending-approvals',
              sideMenu: '/pending-approvals',
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: ':detailId',
            loadComponent: () => import('./home/pending-approvals/details/cheque-details.ng'),
            data: {
              breadcrumb: 'pending-approvals',
              sideMenu: '/pending-approvals',
